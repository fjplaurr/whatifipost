    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, bcrypt_1.compare(candidatePassword, this.password)];
                case 1:
                    isMatch = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    id = req.params.id;
                    return [4 /*yield*/, _1.Post.find({ author: id }).sort('date')];
                case 1:
                    usersPost = _a.sent();
                    return [2 /*return*/, res.status(200).json(usersPost)];
                case 2:
                    err_3 = _a.sent();
                    return [2 /*return*/, next({
                            status: 400,
